...
export function OrderDetails() {
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Pedido: skdknjasjj@@4562782883wsscsa333</DialogTitle>
      ...
      <div className="space-y-6">
        ...
        <Table>
          ...
          <TableBody>
            <TableRow>
              <TableCell>Pizza suprema G</TableCell>
            ...
            <TableRow>
              <TableCell>Pizza portuguesa G</TableCell>
              <TableCell className="text-right">2</TableCell>
